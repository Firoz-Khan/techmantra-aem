        ...
        <div class="container-fluid">
            <div class="navbar navbar-static-top" id="nav">
                <div class="navbar-header">
                    ...
                    <a class="remove_height navbar-brand logo" href="/content/techmantra/index.html"><img src="<%=currentStyle.get("tmlogo", "")%>" alt="TechMantra.com" width="200px" height="93px"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navigation" id="top-custom-navigation">
                        ...
                        <li>
                            <a href="/content/techmantra/index/faqs.html" id="faq" class=" ">FAQS</a>
                            <div class="line2"></div>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/content/techmantra/index/about-us.html" id="about" class=" ">ABOUT US</a>
                            <div class="line4"></div>
                        </li>
                        <li>
